	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					<el-button type="primary" v-on:click="getIllness">查询</el-button>
				</el-form-item>
				<el-form-item>
...
<script>
    ...
    import { getIllnessListPage, deleteIllness, editIllness, addIllness } from '../../api/api';
    ...
    export default {
        ...
        methods: {
            ...
            getIllness() {
                ...
                // NProgress.start();
                getIllnessListPage(name, page).then((res) => {
